...
interface VendorDetailUnsubscribedPublicProps {
  onBack: () => void;
  onLogout: () => void;
...
export function VendorDetailUnsubscribedPublic({ onBack, onLogout, onNavigate, onCreatePost }: VendorDetailUnsubscribedPublicProps) {
